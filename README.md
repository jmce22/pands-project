...
* [Introduction](#introduction)
    * [How to execute my script](#how-to-execute-my-script)
...
Even though they are members of the same Iris family, each Iris species tested has distinct trait measurements on average; it seems to me, therefore, that as far as the four traits measured are concerned, the dataset should be seen as three distinct datasets, rather than one all-encompassing dataset. Setosa especially seems quite different from the other two species.
